...
# OPTIONS #######
tableFile = Path(Path(__file__).parent.parent, "GenerateTable", "HCAS.h5")
trainingDataFiles = (
    str(Path(__file__).parent) + "/HCAS_rect_TrainingData_v6_pra%d_tau%02d.h5"
)
...
saveTaus = [
    ...
    40,
    60,
]  # Tau values at which neural networks will be trained
######################
...
vowns = np.linspace(0, 1100, 12)  # [200.0]
vints = np.linspace(0, 1100, 12)  # [200.0]
