...
# RAM requirements
# Data
# With 2 steps: 16.025 GiB
# With 3 steps: 35.765 GiB
# With 4 steps: 63.378 GiB
# With 5 steps: 98.906 GiB
# With 6 steps: 142.321 GiB
# With 7 steps: 193.646 GiB
# Best fit
# Quadratic: 0.2508 - 0.0067 x + 3.9475 x^2
OWNSPEEDS = [200.0]  # Array(LinRange(0, 1100, 12)) # [200.0] #[100.0,200.0,300.0,400.0]  #ft/s
INTRSPEEDS = [200.0]  # Array(LinRange(0, 1100, 12)) # [200.0] #[100.0,200.0,300.0,400.0]  #ft/s
