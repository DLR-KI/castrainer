...
function POMDPs.transition(mdp::VCAS_MDP, s::stateType, ra::actType)
    h = s[1]
    vown = s[2]
    vint = s[3]
    pra = s[4]
...
# Dynamic equations
function dynamics(h::Float64, vown::Float64, vint::Float64, ownAccel::Float64, intAccel::Float64, ra::Int, mdp::VCAS_MDP)
